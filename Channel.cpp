...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/01/26 16:10:30 by abalhamm          #+#    #+#             */
/*   Updated: 2024/01/26 16:10:33 by abalhamm         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "./includes/Server.hpp"

Channel::Channel(std::string str_n, std::string str_p): user_limit(0), topic(""),  pass(str_p), name(str_n), message("")
{
	// Constructor
	this->mode['l'] = 0;
	this->mode['i'] = 0;
